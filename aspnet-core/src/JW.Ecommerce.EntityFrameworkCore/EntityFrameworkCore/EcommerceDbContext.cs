using JW.Ecommerce.Configurations.Inventories;
using JW.Ecommerce.Configurations.InventoryTickets;
using JW.Ecommerce.Configurations.Manufacturers;
using JW.Ecommerce.Configurations.Orders;
using JW.Ecommerce.Configurations.ProductAttributes;
using JW.Ecommerce.Configurations.ProductCategories;
using JW.Ecommerce.Configurations.Products;
using JW.Ecommerce.Configurations.Promotions;
using JW.Ecommerce.Inventories;
using JW.Ecommerce.InventoryTickets;
using JW.Ecommerce.Manufacturers;
using JW.Ecommerce.Orders;
using JW.Ecommerce.ProductAttributes;
...
namespace JW.Ecommerce.EntityFrameworkCore;
